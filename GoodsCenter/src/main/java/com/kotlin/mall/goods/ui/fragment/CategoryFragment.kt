...
import com.kotlin.mall.goods.presenter.CategoryPresenter
...
//    //二级分类Adapter
    ...
    override fun injectComponent() {
        DaggerCatetgoryComponent.builder().activityComponent(activityComponent).categoryModule(CategoryModule()).build().inject(this)
